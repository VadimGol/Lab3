...
private JMenuItem showDataMenuItem;
...
Action showDataAction = new AbstractAction("О программе") {
public void actionPerformed(ActionEvent event) {

JOptionPane.showMessageDialog(jFrame, "Author: Golovach Vadim | 6 group | 2 course");
}
};
showDataMenuItem = SpravkaMenu.add(showDataAction);
